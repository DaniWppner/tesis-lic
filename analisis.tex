El prototipo implementado \cite{manticore-predicate-abstraction} utiliza Manticore para llevar a cabo el algoritmo [1].
Para esto genera una simulación de la blockchain en la que se despliega el contrato, y luego realiza ejecución simbólica de sus métodos llamándolos desde \textit{accounts} externas en la blockchain.
