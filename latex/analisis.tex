...
Esto se debe a que el paso de restringir las instancias del contrato a aquellas que satisfagan el invariante (y ninguna otra condición) resultó demasiado difícil para el motor de ejecucion simbólica de Manticore, debido a la pobre representación de las variables de tipo \texcolor{cyan}\texttt{uint256[]} del mismo.
